  ...
  <section class="cta-block">
    <div class="cta-block-inner">
      <div class="cta-block-text">
        <h2 class="cta-block-title">BIM・AEC の最新動向を、ここでまとめて</h2>
...
function buildIndex(posts, totalCount = 0) {
  ...
  <section class="hero">
    <div class="hero-inner">
      <div class="hero-left">
        ...
        <h1 class="hero-title">BIM・AEC・建設DXの<br>重要ニュースを<em>AIが深掘り解説</em></h1>
        ...
        <div class="hero-stats">
          ...
          <div class="hero-stat"><strong>厳選</strong><span>して更新</span></div>
  ...
  <section class="cta-block">
    <div class="cta-block-inner">
      <div class="cta-block-text">
        <h2 class="cta-block-title">BIM・AECの最前線を、ここでまとめて</h2>
